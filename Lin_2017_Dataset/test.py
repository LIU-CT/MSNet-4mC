...
load_path = ['Models/scratch/Model_A.pth',
             'Models/scratch/Model_C.pth',
             'Models/scratch/Model_D.pth',
             'Models/scratch/Model_E.pth',
             'Models/scratch/Model_GP.pth',
             'Models/scratch/Model_GS.pth']
'''
